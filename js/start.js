...
(function($){
	...
	// При загрузке страницы скрывается кнопка "Далее", абзац с предложением подписки и сама форма подписки на рассылку.
	$("#next, #offer, #subscribe").hide();

	// В соответствующие абзацы вставляются значения из первого вопроса: текст и 3 изображения.
